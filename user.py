...
class FaceRecognitionSystem:
    def __init__(self, root):
        ...
        # Background image
        img = Image.open(r"C:\Users\shivank\OneDrive\Desktop\face\app\pattern-three.jpeg")
        ...
        # Login Frame
        login_frame = LabelFrame(self.root, text='User', font=('times new roman', 30, 'bold'), bg='#66ffe0')
        ...
        lbl_new_user = Label(self.register_frame, text="New Customer?", font=("times new roman", 20, "bold"), bg="white", fg="red")
    ...
    # Connect to MySQL database
        ...
        if user:
            program_path=r"C:\Users\shivank\OneDrive\Desktop\face\app\hi.py"
    ...
    def register(self):
        ...
        cursor.execute("INSERT INTO userlogin (username, password) VALUES (%s, %s)", (username, password))
        conn.commit()
